...
if($getUserEmailResult > 0) {
    ...
    if($updatePasswordResult == 1) {
        ...
        try {
            ...
            echo '{"result":"fail", "errorCode": "02", "errorMessage": "Message could not be sent. Mailer Error: "'.($mail->ErrorInfo).'"}';
        }
    }
    else {
    ...
    echo '{"result":"fail", "errorCode": "00", "errorMessage": "The email you entered is not registered."}';
}
