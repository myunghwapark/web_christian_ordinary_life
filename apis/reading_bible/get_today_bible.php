        ...
        if($biblePlanId == null) {
            ...
            if($numBiblePlanResult > 0) {
                ...
                if($numResult > 0) {
                    ...
                    echo '{"result":"success", "days": "'.$days.'", "chapter": '.json_encode($chapter).', "biblePlanId": "'.$biblePlanId.'", "bibleProgress": "'.$bibleProgress.'", "lastDay": "'.$lastDay.'"}';
                }
                else {
                ...
                echo '{"result":"fail", "errorCode": "04", "errorMessage": "There is no bible plan."}';
            }
